...
An agent that uses Hackernews Tools to answer questions.

Test:
    python -m agents.hackernews_agent
"""
...
if __name__ == "__main__":
    hackernews_agent.print_response("What tools do you have access to?", stream=True)
